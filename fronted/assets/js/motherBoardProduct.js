...
const productData = {
  mobo1: {
    description: `
      <h3>Gigabyte B650M GAMING X AX: Elevate Your Gaming Experience</h3>
      ...
      <p>Customize your gaming rig with vibrant RGB lighting effects using Gigabyte's RGB Fusion 3.0 software. With support for addressable RGB headers and customizable LED effects, you can personalize your system's lighting to match your gaming setup and create stunning visual effects.</p>
      <h3>User-Friendly Design</h3>
      <p>The Gigabyte B650M GAMING X AX motherboard features a user-friendly design with intuitive BIOS settings and easy-to-use overclocking tools. With Gigabyte's exclusive Q-Flash Plus technology, you can easily update your BIOS without installing a CPU or memory, ensuring hassle-free maintenance and optimization.</p>
      <p>Elevate your gaming experience to the next level with the Gigabyte B650M GAMING X AX motherboard. Whether you're a casual gamer or a competitive esports enthusiast, this motherboard provides the performance, features, and reliability you need for the ultimate gaming experience.</p>
    `,
    images: [
  ...
  mobo2: {
    description: `
      <h3>MSI MAG B650 TOMAHAWK WIFI: Unleash Your Gaming Potential</h3>
      ...
      <p>Immerse yourself in the action with the MSI MAG B650 TOMAHAWK WIFI motherboard's high-quality audio solutions. Equipped with Audio Boost technology and Nahimic audio enhancer, this motherboard delivers immersive sound and crystal-clear audio for a truly immersive gaming experience.</p>
      <h3>Advanced Cooling Solutions</h3>
      ...
      <p>Customize your gaming rig with vibrant RGB lighting effects using MSI's Mystic Light software. With support for customizable LED effects and multiple RGB headers, you can personalize your system's lighting to match your gaming setup and create stunning visual effects.</p>
      <h3>User-Friendly Design</h3>
      <p>The MSI MAG B650 TOMAHAWK WIFI motherboard features a user-friendly design with intuitive BIOS settings and easy-to-use overclocking tools. With MSI's exclusive Click BIOS 5 interface, you can easily fine-tune your system settings and maximize performance with just a few clicks.</p>
      <p>Unleash your gaming potential with the MSI MAG B650 TOMAHAWK WIFI motherboard. Whether you're a casual gamer or a hardcore enthusiast, this motherboard provides the performance, features, and reliability you need to dominate the competition and take your gaming experience to the next level.</p>
    `,
    images: [
  ...
  mobo3: {
    description: `
      <h3>ASUS PRIME B660-PLUS DDR4: Elevate Your PC Experience</h3>
      ...
      <p>Stay connected and productive with the ASUS PRIME B660-PLUS DDR4 motherboard's comprehensive connectivity options. Equipped with multiple USB ports, including USB 3.2 Gen 2 and USB-C, as well as Gigabit LAN and PCIe slots, this motherboard provides ample connectivity for all your devices and peripherals.</p>
      <h3>Enhanced Audio</h3>
      <p>Immerse yourself in high-quality audio with the ASUS PRIME B660-PLUS DDR4 motherboard's built-in audio solutions. Featuring ASUS' exclusive audio technologies, including Realtek S1200A codec and audio shielding, this motherboard delivers crystal-clear sound for an immersive multimedia experience.</p>
      ...
      <p>Elevate your PC experience with the ASUS PRIME B660-PLUS DDR4 motherboard. Whether you're building a new system or upgrading your existing one, this motherboard offers the performance, reliability, and features you need to take your computing to the next level.</p>
    `,
    images: [
  ...
  mobo4: {
    description: `
      <h3>MSI Z790 GAMING PLUS WIFI: Elevate Your Gaming Experience</h3>
      ...
      <h3>Advanced Cooling Solutions</h3>
      <p>Keep your system cool and stable during intense gaming sessions with MSI's advanced cooling solutions. Equipped with an extended heatsink design, M.2 Shield Frozr, and Frozr AI Cooling, this motherboard ensures optimal thermal performance for your components, allowing you to push your system to its limits without overheating.</p>
      ...
      <p>Unlock the full potential of your hardware with MSI's intuitive BIOS interface and advanced overclocking features. With MSI's exclusive Core Boost technology and DDR5 Boost, you can easily overclock your CPU and memory for maximum performance without compromising stability.</p>
  ...
  mobo5: {
    description: `
      <h3>ASUS TUF GAMING B760-PLUS WIFI DDR4: Built to Withstand the Rigors of Gaming</h3>
      ...
      <h3>Powerful Performance</h3>
      <p>Powered by Intel's latest B760 chipset, the TUF GAMING B760-PLUS WIFI DDR4 motherboard supports 12th generation Intel Core processors, providing exceptional performance for gaming, multitasking, and content creation. With support for DDR4 memory and PCIe 5.0 technology, this motherboard delivers blazing-fast speeds and responsive performance for the most demanding tasks.</p>
  ...
  mobo6: {
    description: `
      <h3>MSI MAG B550 TOMAHAWK WIFI: Power and Performance for Gaming Enthusiasts</h3>
      ...
      <p>The MAG B550 TOMAHAWK WIFI features MSI's Click BIOS 5, which offers an intuitive interface for easy system configuration and overclocking. Plus, with MSI Dragon Center software, you can monitor system performance, adjust fan speeds, and customize RGB lighting from a single dashboard.</p>
  ...
  mobo7: {
    description: `
      <h3>Gigabyte B450 AORUS ELITE V2: Reliable Performance for Gaming and Productivity</h3>
      ...
      <p>The B450 AORUS ELITE V2 features Gigabyte's award-winning BIOS interface, which offers easy access to advanced features and settings. With intuitive navigation and comprehensive system monitoring tools, you can fine-tune your system for optimal performance.</p>

      <p>Overall, the Gigabyte B450 AORUS ELITE V2 motherboard offers reliable performance, advanced features, and customizable options for gamers and PC enthusiasts alike. Whether you're building a gaming PC or a productivity workstation, this motherboard provides a solid foundation for your build.</p>
    `,
    images: [
  ...
  mobo8: {
    description: `
      <h3>ASUS ROG STRIX B550-F GAMING: Elevate Your Gaming Experience</h3>
      ...
      <p>Overall, the ASUS ROG STRIX B550-F GAMING motherboard offers gamers a premium gaming experience with its powerful performance, advanced features, and customizable options. Whether you're a casual gamer or a competitive esports player, this motherboard provides the performance and reliability you need to dominate the battlefield.</p>
    `,
    images: [
  ...
  mobo9: {
    description: `
      <h3>Gigabyte B550 AORUS ELITE V2: Elevate Your Gaming Rig</h3>
      ...
      <h3>Advanced Cooling Solutions</h3>
      <p>Stay cool under pressure with the B550 AORUS ELITE V2's comprehensive cooling solutions. Featuring an advanced thermal design with multiple fan headers, heatsinks, and thermal pads, this motherboard ensures efficient heat dissipation to keep your system running smoothly, even during intense gaming sessions.</p>
      ...
      <p>Immerse yourself in the game with Gigabyte's high-fidelity audio technology. The B550 AORUS ELITE V2 features an advanced audio chipset and premium audio capacitors, delivering crystal-clear sound quality and immersive gaming audio that brings your games to life.</p>

      <h3>RGB Fusion 2.0</h3>
      <p>Customize your gaming rig with Gigabyte's RGB Fusion 2.0 technology. With customizable RGB lighting zones and effects, you can personalize your setup to match your style and create a gaming environment that's truly unique.</p>

      <h3>Easy-to-Use BIOS Interface</h3>
      <p>Access advanced features and settings with ease thanks to Gigabyte's user-friendly BIOS interface. With intuitive controls and comprehensive system monitoring tools, you can optimize your system for maximum performance and stability.</p>
  ...
  mobo10: {
    description: `
      <h3>ASUS PRIME B550-PLUS: Your Gateway to Next-Gen Gaming</h3>
      ...
      <h3>Comprehensive Cooling Solutions</h3>
      <p>Keep your system cool under pressure with the PRIME B550-PLUS's comprehensive cooling solutions. With multiple fan headers, heatsinks, and thermal pads, this motherboard ensures efficient heat dissipation to maintain optimal performance even during intense gaming sessions.</p>
