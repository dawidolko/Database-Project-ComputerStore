...
const productData = {
  set1: {
    ...
    <p>We provide a Door-to-Door warranty for the purchased set, meaning that in the event of a component failure, we'll collect the defective part or the entire computer from you and service it according to the manufacturer's warranty terms.</p>
     `,
    images: ["../assets/images/products/computers/computer1.webp"],
  },
  set2: {
    description: `
    ...
    `,
    images: ["../assets/images/products/computers/computer2.webp"],
  },
  set3: {
    description: `
    ...
    `,
    images: ["../assets/images/products/computers/computer3.webp"],
  },
  set4: {
    description: `
    ...
    images: ["../assets/images/products/computers/computer4.webp"],
  },
  set5: {
    description: `
    <h3>Why Choose a Ready-Made Computer Set?</h3>
    ...
    images: ["../assets/images/products/computers/computer5.webp"],
  },
  set6: {
    description: `
    ...
    <p>With our Door-to-Door warranty, you can rest assured that in the event of a component failure, we've got you covered. Whether it's collecting the defective component or the entire computer from you, we'll service it in accordance with the warranty terms of the manufacturer, ensuring minimal disruption to your gaming experience.</p>`,
    images: ["../assets/images/products/computers/computer6.webp"],
  },
  set7: {
    description: `
    <h3>Why Choose a Ready-Made Computer Set?</h3>
    ...
    images: ["../assets/images/products/computers/computer7.webp"],
  },
  set8: {
    description: `
    <h3>Why Choose a Ready-Made Computer Set?</h3>
    ...
    images: ["../assets/images/products/computers/computer8.webp"],
  },
  set9: {
    description: `
    ...
    images: ["../assets/images/products/computers/computer9.webp"],
  },
};
