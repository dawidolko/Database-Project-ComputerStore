...
SET DEFINE OFF;
Insert into SKLEP.CUSTOMERS (ID,NAME,LAST_NAME,DELIVERY_ADDRESS,PHONE_NUMBER,EMAIL,PASSWORD) values ('1','Ró¿a','Kraszkiewicz','pl. Graniczna 33 52-606 Police','576 741 468         ','cczerner@onet.pl','MQ8FlMj4&tV9                                                    ');
Insert into SKLEP.CUSTOMERS (ID,NAME,LAST_NAME,DELIVERY_ADDRESS,PHONE_NUMBER,EMAIL,PASSWORD) values ('2','Hubert','Szarzec','ulica Sk³odowskiej-Curie 93 87-069 Zduñska Wola','608 986 389         ','yjarmuz@grupa.net','n#6#42Bsqo8D                                                    ');
Insert into SKLEP.CUSTOMERS (ID,NAME,LAST_NAME,DELIVERY_ADDRESS,PHONE_NUMBER,EMAIL,PASSWORD) values ('3','Dorota','Borak','pl. Lubelska 76/98 57-794 Przemyœl','694 988 359         ','angelika84@interia.pl','A_Y_pY0pIO7F                                                    ');
...
Insert into SKLEP.CUSTOMERS (ID,NAME,LAST_NAME,DELIVERY_ADDRESS,PHONE_NUMBER,EMAIL,PASSWORD) values ('6','Grzegorz','¯o³¹dkiewicz','ulica Towarowa 41 61-434 Œwiecie','691 404 907         ','igrzywnowicz@borejko-kapral.pl','!mNShAKf_^6W                                                    ');
Insert into SKLEP.CUSTOMERS (ID,NAME,LAST_NAME,DELIVERY_ADDRESS,PHONE_NUMBER,EMAIL,PASSWORD) values ('7','Nela','Plewnia','pl. Staffa 30 67-674 Ostrowiec Œwiêtokrzyski','888 342 505         ','kukuczkacyprian@ppuh.pl','^3*YwBXd6ItO                                                    ');
Insert into SKLEP.CUSTOMERS (ID,NAME,LAST_NAME,DELIVERY_ADDRESS,PHONE_NUMBER,EMAIL,PASSWORD) values ('8','Adrianna','Goworek','pl. Krañcowa 29/72 58-694 Oœwiêcim','662 165 353         ','justynakosciolek@fpuh.com','y9OEYxiB^@8f                                                    ');
Insert into SKLEP.CUSTOMERS (ID,NAME,LAST_NAME,DELIVERY_ADDRESS,PHONE_NUMBER,EMAIL,PASSWORD) values ('9','Stanis³aw','Hawrylak','ul. Osiedlowa 38/19 63-584 Chorzów','505 436 705         ','nmich@interia.pl','v!J9BMs)&%6D                                                    ');
Insert into SKLEP.CUSTOMERS (ID,NAME,LAST_NAME,DELIVERY_ADDRESS,PHONE_NUMBER,EMAIL,PASSWORD) values ('10','Juliusz','Roczniak','ulica Makuszyñskiego 110 50-650 Skierniewice','786 072 638         ','adammachniak@fpuh.pl','nKL7uWQzGo@a                                                    ');
...
Insert into SKLEP.CUSTOMERS (ID,NAME,LAST_NAME,DELIVERY_ADDRESS,PHONE_NUMBER,EMAIL,PASSWORD) values ('12','Maksymilian','Saczuk','plac Górska 065 35-648 Lubin','888 093 377         ','fkornet@gmail.com','u3^SlCKh(S!7                                                    ');
...
Insert into SKLEP.CUSTOMERS (ID,NAME,LAST_NAME,DELIVERY_ADDRESS,PHONE_NUMBER,EMAIL,PASSWORD) values ('14','Dagmara','Królczyk','aleja Królewska 512 07-942 Che³m','698 720 861         ','sandrakrus@fpuh.pl','@jYSW+z^u6au                                                    ');
Insert into SKLEP.CUSTOMERS (ID,NAME,LAST_NAME,DELIVERY_ADDRESS,PHONE_NUMBER,EMAIL,PASSWORD) values ('15','Pawe³','£yp','plac Wi¹zowa 20/40 81-712 Kraœnik','22 888 55 88        ','nela53@stowarzyszenie.net','!6KIjHCAf6yk                                                    ');
Insert into SKLEP.CUSTOMERS (ID,NAME,LAST_NAME,DELIVERY_ADDRESS,PHONE_NUMBER,EMAIL,PASSWORD) values ('16','Tobiasz','Pietrus','aleja Wspólna 57 39-619 Lubliniec','786 448 347         ','mateuszniescior@yahoo.com',')HU+SVxl1ZHq                                                    ');
...
Insert into SKLEP.CUSTOMERS (ID,NAME,LAST_NAME,DELIVERY_ADDRESS,PHONE_NUMBER,EMAIL,PASSWORD) values ('18','Nicole','Chomiak','plac Kopernika 36 20-273 ¯agañ','574 040 962         ','dberendt@hotmail.com','!MvQDuyjDP5V                                                    ');
Insert into SKLEP.CUSTOMERS (ID,NAME,LAST_NAME,DELIVERY_ADDRESS,PHONE_NUMBER,EMAIL,PASSWORD) values ('19','Marianna','Sommerfeld','ulica Ludowa 20 14-589 Ostrów Mazowiecka','781 883 103         ','olaf94@grupa.com','*#rPUNspOS5h                                                    ');
Insert into SKLEP.CUSTOMERS (ID,NAME,LAST_NAME,DELIVERY_ADDRESS,PHONE_NUMBER,EMAIL,PASSWORD) values ('20','Urszula','Smyka³a','aleja Nadbrze¿na 02/43 14-979 Gdañsk','691 234 921         ','aleksandertarasek@hotmail.com','^hZNGilyA3Qi                                                    ');
commit;
...
Insert into SKLEP.EMPLOYEES (ID,NAME,LAST_NAME,JOB_POSITION,EMAIL,PHONE_NUMBER) values ('13','Justyna','RzeŸniczek','Technik PC','ngaudyn@interia.pl','508 449 644         ');
