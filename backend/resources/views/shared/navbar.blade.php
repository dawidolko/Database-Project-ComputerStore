      ...
      <div class="header-main">
        <div class="container">
          ...
          <div class="header-user-actions">
            ...
            <a href="{{ route('favorite') }}" class="action-btn" style="text-align: center;">
              <ion-icon name="heart-outline" style="font-size: 24px; color: #757575;"></ion-icon>
              <span class="count-favorite">{{ session('favoritesCount', 0) }}</span>
            </a>
          
          <a href="{{ route('cart') }}" class="action-btn" style="text-align: center;">
              <ion-icon name="bag-handle-outline" style="font-size: 24px; color: #757575;"></ion-icon>
          ...
          <ul class="desktop-menu-category-list">
            ...
            <li class="menu-category">
              ...
              <div class="dropdown-panel">
                ...
                <ul class="dropdown-panel-list">
                  ...
                  <li class="panel-list-item">
                    <a href="{{ route('components.index') }}#processors">Processors</a>
                  </li>

                  <li class="panel-list-item">
                    <a href="{{ route('components.index') }}#graphics">Graphics</a>
                  </li>

                  <li class="panel-list-item">
                    <a href="{{ route('components.index') }}#powerSupply">Power supply</a>
                  </li>

                  <li class="panel-list-item">
                    <a href="{{ route('components.index') }}#all">
                      <img
                ...
                <ul class="dropdown-panel-list">
                  <li class="panel-list-item">
                    <a href="{{ route('components.index') }}#cooling">Cooling</a>
                  </li>

                  <li class="panel-list-item">
                    <a href="{{ route('components.index') }}#disks">Disks</a>
                  </li>

                  <li class="panel-list-item">
                    <a href="{{ route('components.index') }}#fans">Fans</a>
                  </li>

                  <li class="panel-list-item">
                    <a href="{{ route('components.index') }}#motherboards">Motherboards</a>
                  </li>
            ...
            <li class="menu-category">
              ...
              <ul class="dropdown-list">
                ...
                <li class="dropdown-item">
                  <a href="{{ route('components.index') }}#memoryRam">Memory RAM</a>
                </li>
                ...
                <li class="dropdown-item">
                  <a href="{{ route('components.index') }}#cases">Cases</a>
                </li>
